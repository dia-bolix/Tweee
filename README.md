...
Tweee is an android app that allows a user to view his Twitter timeline. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='https://github.com/dia-bolix/Tweee/blob/master/tweee_preview.gif?raw=true' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [DU Gif Maker](https://play.google.com/store/apps/details?id=com.duapps.gif.emoji.gifmaker&hl=en_US).

### Notes

The most difficult part was getting the rest template to work with Android studio.
